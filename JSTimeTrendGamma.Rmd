...
data = list(y = rbind(y, M), nind = nind, nyears = nyears, time = seq(1:nyears))
    ```
...
jm <- jags.model(file = textConnection(JS), data = data, inits = rinits(), n.chains = 3, n.adapt = 500)
...
saveRDS(samples, file = "JSTimeTrendGamma.rda")
```
